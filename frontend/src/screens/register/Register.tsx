    ...
    <SafeAreaView style={styles.screenContainer}>
      <View style={styles.mainContainer}>
        ...
        <View style={styles.textInputContainer}>
          ...
          <TextInput placeholder="Confirmer le mot de passe" placeholderTextColor="#6C6D72" style={styles.textInputStyle} />
          <TouchableOpacity style={styles.nextButtonStyle} onPress={handleNextPress}>
