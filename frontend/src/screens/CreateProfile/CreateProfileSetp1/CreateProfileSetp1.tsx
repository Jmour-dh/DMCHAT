...
const CreateProfileSetp1: React.FC = ({onNextStep}) => {
  ...
  const validationSchema = yup.object().shape({
    ...
    sexe: yup.string().required('Veuillez sélectionner votre sexe'),
  });
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <View style={styles.textInputContainer}>
        ...
        <TextInput placeholder="Prénom" placeholderTextColor="#6C6D72" style={styles.textInputStyle} value={lastname} onChangeText={text => setLastname(text)} />
