...
import {checkCameraAndStoragePermission} from '../Permissions/PermissionsAndroid';
...
const ProfileImagePickerAndroid: React.FC<Props> = ({onImageSelected, modalVisible, setModalVisible}) => {
  const handleTakePhoto = async () => {
    console.log('Demande de permission de caméra android...');
    const hasCameraPermission = await checkCameraAndStoragePermission();
    if (!hasCameraPermission) {
      console.log('Permission de caméra refusée android');
  ...
  const handleChooseFromLibrary = async () => {
    ...
    if (!hasStoragePermission) {
      console.log('Permission de stockage refusée android');
